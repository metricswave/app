...
export default function App() {
    ...
    return (
        <div className="">
            <header id="top-nav-menu" className="flex flex-col fixed top-0 left-0 right-0 border-b soft-border drop-shadow-sm dark:drop-shadow-xl z-30">
                {showLimitBanner && <div className="bg-red-200 py-3 px-5">
                    <div className="max-w-2xl text-sm mx-auto">
                        You have exceeded the limit of events allowed in your plan. <a className="text-red-700 border-b border-dotted border-red-700 font-bold" href="/settings/billing">Upgrade your site &rarr;</a>
                    </div>
                </div>}
            ...
            <div id="app-container"
                 className={`${paddingTop} pb-[81px] sm:pb-0`}>
                <Outlet/>
            </div>

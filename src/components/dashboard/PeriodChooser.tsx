...
import {Period, periods, periodsWithSeparators} from "../../types/Period"
...
export function PeriodChooser(
    {
        ...
        setPeriodAndDate: (period: Period) => void
        compareWithPrevious: boolean,
        setCompareWithPrevious: (compare: boolean) => void
    },
) {
    return <div className="flex flex-col w-full sm:w-auto sm:flex-row flex-grow sm:items-center sm:justify-end space-y-3 sm:space-y-0 sm:space-x-3 min-w-[200px] border soft-border p-2">
        <DropdownMenu.Root>

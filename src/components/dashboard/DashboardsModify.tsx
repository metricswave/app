...
export function DashboardsModify() {
    ...
    function setItemsAndUpdateDashboard(items: SortableItem[]) {
        setItems(items);
        updateAndSaveDashboard(dashboardId, {
    ...
    return (
        <SectionContainer className="sm:pt-12">
        ...
        >
            <div className="flex justify-between items-center">
                ...
                <ul className="flex items-center gap-4">
                    {!open && (
                        <>
                            <li onClick={() => setOpen(id)} className="cursor-pointer">
                            ...
                            >
                                <div
                                    className={twMerge(
                                        ...
                                        {
                                            "bg-red-100 border-red-200 dark:border-red-900/50 dark:bg-red-900/75":
                                                deleteConfirm,
                                        },
                                    )}
                                >
                ...
                <div className="flex items-center justify-center overflow-hidden">
                    <div className="pt-5 w-full">
                        <EditWidget
                            ...
                            eventOtherEvents={item.otherEvents ?? []}

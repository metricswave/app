                ...
                <DropdownMenu.Root>
                    <DropdownMenu.Trigger asChild>
                        <div className="p-2 w-full flex-grow flex flex-row items-center justify-center rounded-sm cursor-pointer hover:bg-zinc-100/90 dark:hover:bg-zinc-700/10">
                            <div className="w-full">{activeDashboard.name}</div>
                ...
                >
                                ...
                                <div>
                                    <div className="p-2 border soft-border">
                                        ...
                                        <div className="max-w-full truncate text-xs select-all">
                                            {publicDashboardPath(dashboard)}
                                        </div>
                                    </div>
                                </div>
                            )}

                            <PrimaryButton size={"small"} text={"Update"} onClick={handleUpdate} />
                    ...
                    {view === "delete" && (
                        <div className="flex flex-col gap-2.5">
                            ...
                            <p className="opacity-70 text-sm mb-2.5">This action cannot be undone.</p>

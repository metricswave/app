...
export default function SettingsMenu() {
    ...
    const currentItem = panelItems
            .find((item) => window.location.pathname === item.path)
        || panelItems[0]
            ...
            <div className="sm:hidden px-8 pt-8 pb-2">
                <Select.Root value={currentItem.path}
                    ...
                    <Select.Portal className="drop-shadow rounded p-4 max-w-screen">
                        <Select.Content
                            className="overflow-hidden bg-[var(--form-select-content-background)] rounded-md shadow w-full z-50"
                        >
